<?php
session_start(); // Mulai sesi untuk pengecekan login
...
// Menambahkan logika untuk mengambil data user, jika perlu
// Misalnya, mengambil username atau nama pengguna
include('database.php');
$query = "SELECT * FROM users WHERE id = '$user_id'";
$result = $conn->query($query);
$user = $result->fetch_assoc();
$username = $user['name']; // Menyimpan nama pengguna dalam variabel
?>
...
<head>
    ...
    <link rel="stylesheet" href="assets/css/home-log.css">
</head>
